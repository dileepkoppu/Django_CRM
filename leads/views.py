...
class DashboardView(OrganisorAndLoginRequiredMixin, generic.TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # qy=self.request.user.userprofile
...
class CategoryListView(LoginRequiredMixin, generic.ListView):
    ...
    def get_context_data(self, **kwargs):
        context_temp = super(CategoryListView, self).get_context_data(**kwargs)
        user = self.request.user
        ...
        context={'data':{}}
        for category in context_temp['category_list']:

            context['data'].update({
                category.name:[
                    category.pk,
                    queryset.filter(category__name=category).count()
                ]
            })
